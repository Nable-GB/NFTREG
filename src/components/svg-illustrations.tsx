...
export const IconTelegram = ({ className = "", style }: { className?: string; style?: React.CSSProperties }) => (
...
export const IconWhatsApp = ({ className = "", style }: { className?: string; style?: React.CSSProperties }) => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={style}>
...
export const IconKakao = ({ className = "", style }: { className?: string; style?: React.CSSProperties }) => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={style}>
    <path d="M12 3c-5.08 0-9.2 3.34-9.2 7.47 0 2.67 1.74 5.01 4.37 6.36-.14.49-.9 3.17-.93 3.37 0 0-.02.16.08.22.1.06.22.01.22.01.29-.04 3.35-2.18 3.88-2.55.51.07 1.04.11 1.58.11 5.08 0 9.2-3.34 9.2-7.47S17.08 3 12 3z" fill="currentColor" />
  </svg>
);
